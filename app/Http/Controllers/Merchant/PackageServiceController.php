...
class PackageServiceController extends Controller
{
    ...
    public function create(){
        return view('merchant.package_service.create');
    }
    public function show(){
        return view('merchant.package_service.list');
    }
    public function edit($id){
      $content['r']=  PackageService::where('id',$id)->where('created_by',Auth::id())->first();
      return view('merchant.package_service.edit',$content);  
    }
    ...
    function showList(){        
        ...
        return Datatables::of($record) 
            ...
            ->addColumn('actions',function($record) {
                $actions = '<a href="'. route('merchant.service.editForm',$record->id).'" class="on-default"><i class="fas fa-pencil-alt"></i></a> &nbsp;';
                //$actions.= '<a href="javascript:void(0);" data-url="'. route('merchant.service.deleteAjax',$record->id).'" class="on-default sa-warning"><i class="fas fa-trash-alt"></i></a> &nbsp;';
                return $actions;
            })
