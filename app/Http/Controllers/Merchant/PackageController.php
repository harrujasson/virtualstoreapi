...
class PackageController extends Controller
{
    ...
    public function create(){
        ...
        return view('merchant.package.create',$data);
    }
    public function show(){
        return view('merchant.package.list');
    }
    public function edit($id){
      ...
      return view('merchant.package.edit',$content);  
    }
    ...
    function showList(){        
        ...
        return Datatables::of($record) 
            ...
            ->addColumn('actions',function($record) {
                $actions = '<a href="'. route('merchant.package.editForm',$record->id).'" class="on-default"><i class="fas fa-pencil-alt"></i></a> &nbsp;';
                $actions.= '<a href="javascript:void(0);" data-url="'. route('merchant.package.deleteAjax',$record->id).'" class="on-default sa-warning"><i class="fas fa-trash-alt"></i></a> &nbsp;';
                return $actions;
            })
    ...
    function delete($id){
        echo Package::where('created_by',Auth::id())->where("id",$id)->delete();  
        die();
