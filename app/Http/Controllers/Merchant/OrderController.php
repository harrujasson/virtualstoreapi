...
class OrderController extends Controller
{
    ...
    public function show(){
        return view('merchant.order.list');
    }
    function showList(){        
        ...
        return Datatables::of($record) 
            ...
            ->addColumn('actions',function($record) {
                $actions = '<a href="'. route('merchant.orders.view',$record->id).'" class="on-default"><i class="fas fa-search-plus"></i></a>';                
                return $actions;
            })
    ...
    public function show_client(){
        return view('merchant.order.client_list');
    }
    function showListClient(){        
        $record = Order::with(['user','package'])->where('merchant_id',Auth::id())->where('transaction_for','Client');    
    ...
    function view($id=''){
        ...
        return view('merchant.order.view',$content);
    }
