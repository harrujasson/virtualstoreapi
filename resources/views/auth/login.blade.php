                    ...
                    <div class="card-body">
                        <div class="px-3">
                            ...
                            <div class="text-center auth-logo-text">
                                <h4 class="mt-0 mb-3 mt-5">Let's Get Started {{Config::get('constants.AppnameGlobe') }}</h4>
                                <p class="text-muted mb-0">Sign in to continue to {{Config::get('constants.AppnameGlobe') }}.</p>
                            ...
                            <form class="form-horizontal auth-form my-4" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="email" type="email" placeholder="Email" class="form-control @error('email') is-invalid @enderror" name="email" @if(old('email')) value="{{ old('email') }}"  @endif value="{{ old('email') }}" required autocomplete="email" autofocus>
