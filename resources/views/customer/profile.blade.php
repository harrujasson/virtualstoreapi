    ...
    <div class="col-lg-8 col-md-12 mx-auto">
        ...
        <div class="card">
            ...
            @include('widget/notifications')
                ...
                <form class="needs-validation" novalidate method="post" action="{{ route('customer.myprofile_save',[get_route_url()]) }}"  enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="company_name"  value="{{ old('company_name', $r->company_name) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="street" value="{{ old('street', $r->street) }}"  >
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label>Town / City <code>*</code></label>
                                <input type="text" class="form-control" name="city" required value="{{ old('city', $r->city) }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label>County <code>*</code></label>
                                <input type="text" required class="form-control" name="country" required value="{{ old('country', $r->country) }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label  class="form-label">Postcode / ZIP <code>*</code></label>
                                <input type="text" class="form-control" required name="zipcode" value="{{ old('zipcode', $r->zipcode) }}"  >
                            </div>
                        </div>
                    </div>
