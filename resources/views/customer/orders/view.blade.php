                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                           @if($r->status == "")
                                           <span class='badge badge-pill badge-soft-warning'>Under Process</span>
                                           @else
                                           <span class='badge badge-pill badge-soft-success'>{{ $r->status  }}</span>
                                           @endif
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row mb-4 mt-4">
                                        ...
                                        <div class="col-sm-9">
                                            @if($r->cancel =="1")
                                                <span class="label label-success"><strong><i>Cancelled</i></strong></span>
                                                <hr class="mt-2 mb-2">
                                    ...
                                    <div class="cancel_order_container"  style="display:none;">
                                        ...
                                        <form method="post" action="{{route('customer.cancel_order',$r->id)}}">
                                            ...
                                            <div class="row mb-4 mt-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control" row="3" name="reason_cancel">{{$r->reason_cancel}}</textarea>
                                                </div>
                                            </div>
                                ...
                                <div class="panel-footer">
                                    <div class="row">
                                        <div class="col-sm-12 col-sm-offset-3">
                                            <div class="row">
                                                <div class="col-12"><a class="btn btn-primary waves-effect waves-light w-sm" download="" href="{{ asset('invoice/invoice_order_') }}{{ $r->id }}.pdf">Download Order as PDF</a> </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#cancelorderControl").change(function(){
            if($(this).is(":checked")){
                $(".cancel_order_container").show();
            }else{
                $(".cancel_order_container").hide();
            }   
        })
    });
</script>
